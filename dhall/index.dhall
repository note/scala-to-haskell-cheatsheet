...
let haskellFunctionsDefs =
      ...
      , hask
          ...
          ( Some
              ''
              Many tutorials use ${F.code
                                     "let triple :: ..."}. There's <a href="https://stackoverflow.com/a/42988998/429311">no difference</a> between those two notations in GHCi so it's up to you to decide .
              ''
          )
